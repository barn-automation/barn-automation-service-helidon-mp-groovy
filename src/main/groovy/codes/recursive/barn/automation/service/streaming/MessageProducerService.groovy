...
class MessageProducerService {
    private static final Logger log = Logger.getLogger(MessageProducerService.class.name)

    String configFilePath
    String streamId
    StreamClient client

    MessageProducerService(configFilePath=System.getProperty("ociConfigPath"), streamId=System.getProperty("incomingStreamId")) {
